...
class ElasticPress
{
    ...
    /**
     * @var \Yard\OpenConvenanten\Repository\OpenConvenantenRepository
     */
    protected $repository;

    public function __construct(Config $config, OpenConvenantenRepository $repository)
    {
        $this->config = $config;
    ...
    public function setFilters(): void
    {
        ...
        \add_filter('ep_indexable_post_types', [$this, 'removeOpenConvenanten'], 10, 1);
    }
    ...
    public function removeOpenConvenanten($postTypes): array
    {
        unset($postTypes['openconvenanten-item']);
    ...
    {
        return \get_option('_ow_openwoo_settings', []);
    }
}
